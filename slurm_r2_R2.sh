#!/bin/bash
# slurm_r2_R2.sh — add_topo_bound_constraint only
#SBATCH --job-name=r2_R2
...
#SBATCH --output=logs/r2_R2_%j.out
#SBATCH --error=logs/r2_R2_%j.err
...
OUT="${PROJ}/results/config_R/isolation/R2_topo_bound"
...
echo "=== Config R2: add_topo_bound_constraint only (452 ranks, 6 nodes) ==="
