...
#SBATCH --output=logs/r2_G_serial64_%j.out
#SBATCH --error=logs/r2_G_serial64_%j.err
...
OUT="${PROJ}/results/round2/config_G/serial_mp_64"
mkdir -p "${OUT}/tmp" logs
load_ocsmesh_env

echo "=== Config G serial_mp nprocs=64 ==="
