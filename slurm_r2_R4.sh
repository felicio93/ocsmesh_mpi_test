#!/bin/bash
# slurm_r2_R4.sh — add_subtidal_flow_limiter only
#SBATCH --job-name=r2_R4
...
#SBATCH --output=logs/r2_R4_%j.out
#SBATCH --error=logs/r2_R4_%j.err
...
OUT="${PROJ}/results/config_R/isolation/R4_flow_limiter"
...
echo "=== Config R4: add_subtidal_flow_limiter only (452 ranks, 6 nodes) ==="
