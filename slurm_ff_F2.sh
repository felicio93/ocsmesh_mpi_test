#!/bin/bash
# slurm_ff_F2.sh — add_topo_bound_constraint only (value=2km)
#SBATCH --job-name=ff_F2
...
#SBATCH --output=logs/ff_F2_%j.out
#SBATCH --error=logs/ff_F2_%j.err
...
OUT="${PROJ}/results/config_ffat/isolation/F2_topo_bound"
...
echo "=== Config F2: add_topo_bound_constraint only (value=2km, 45 ranks) ==="
