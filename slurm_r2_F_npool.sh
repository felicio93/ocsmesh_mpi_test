...
#SBATCH --output=logs/r2_F_npool_%j.out
#SBATCH --error=logs/r2_F_npool_%j.err
...
OUT="${PROJ}/results/round2/config_F/mpi_no_pool"
mkdir -p "${OUT}/tmp" logs
load_ocsmesh_env

echo "=== Config F mpi_no_pool (9 ranks, 1 core/rank) ==="
