#!/bin/bash
# slurm_ff_F1.sh — add_constant_value only
#SBATCH --job-name=ff_F1
...
#SBATCH --output=logs/ff_F1_%j.out
#SBATCH --error=logs/ff_F1_%j.err
...
OUT="${PROJ}/results/config_ffat/isolation/F1_constant_value"
...
echo "=== Config F1: add_constant_value only (45 ranks) ==="
