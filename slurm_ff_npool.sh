...
#SBATCH --output=logs/ff_npool_%j.out
#SBATCH --error=logs/ff_npool_%j.err
...
OUT="${PROJ}/results/config_ffat/mpi_no_pool"
...
echo "=== Config F-fat mpi_no_pool (45 ranks, 1 core/rank) ==="
