#!/bin/bash
# slurm_r2_R3.sh — add_contour only
#SBATCH --job-name=r2_R3
...
#SBATCH --output=logs/r2_R3_%j.out
#SBATCH --error=logs/r2_R3_%j.err
...
OUT="${PROJ}/results/config_R/isolation/R3_contour"
...
echo "=== Config R3: add_contour only (452 ranks, 6 nodes) ==="
