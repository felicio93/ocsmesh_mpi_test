...
#SBATCH --output=logs/r2_F_serial79_%j.out
#SBATCH --error=logs/r2_F_serial79_%j.err
...
OUT="${PROJ}/results/round2/config_F/serial_mp_79"
mkdir -p "${OUT}/tmp" logs
load_ocsmesh_env

echo "=== Config F serial_mp nprocs=79 ==="
