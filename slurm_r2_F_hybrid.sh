...
#SBATCH --output=logs/r2_F_hybrid_%j.out
#SBATCH --error=logs/r2_F_hybrid_%j.err
...
OUT="${PROJ}/results/round2/config_F/mpi_hybrid"
mkdir -p "${OUT}/tmp" logs
load_ocsmesh_env

echo "=== Config F mpi_hybrid (9 ranks, 8 cores/rank) ==="
