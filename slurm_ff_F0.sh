#!/bin/bash
# slurm_ff_F0.sh — no refinements
#SBATCH --job-name=ff_F0
...
#SBATCH --output=logs/ff_F0_%j.out
#SBATCH --error=logs/ff_F0_%j.err
...
OUT="${PROJ}/results/config_ffat/isolation/F0_no_refinements"
...
echo "=== Config F0: flat background (45 ranks) ==="
