#!/bin/bash
# slurm_r2_R0.sh — no refinements
#SBATCH --job-name=r2_R0
...
#SBATCH --output=logs/r2_R0_%j.out
#SBATCH --error=logs/r2_R0_%j.err
...
OUT="${PROJ}/results/config_R/isolation/R0_no_refinements"
...
echo "=== Config R0: flat background (452 ranks, 6 nodes) ==="
