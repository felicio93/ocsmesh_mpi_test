#!/bin/bash
# slurm_ff_full_npool.sh — full Config F-fat, mpi_no_pool
#SBATCH --job-name=ff_full_npool
...
#SBATCH --output=logs/ff_full_npool_%j.out
#SBATCH --error=logs/ff_full_npool_%j.err
...
OUT="${PROJ}/results/config_ffat/full/mpi_no_pool"
...
echo "=== Config F-fat full mpi_no_pool (45 ranks, 44 tiles) ==="
